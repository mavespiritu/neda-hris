...
const RemarksForm = ({ indicator, open, onClose, onSuccess }) => {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('cga.review.update-indicator.remarks', indicator?.id), {
            preserveState: true,
            preserveScroll: true,
            onSuccess: (res) => {
                ...
                clearErrors()
                onClose()
                onSuccess(indicator, data.remarks)
            },
            onError: (res) => {
        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                    Add narrative as to why the compliance to the indicator must be changed. 
                    </DialogDescription>
                </DialogHeader>
