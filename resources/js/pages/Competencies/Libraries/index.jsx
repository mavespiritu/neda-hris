...
const breadcrumbItems = [
  { label: "Home", href: "/" },
  { label: "Competencies" },
  { label: "Libraries", href: route("cga.libraries") },
]
...
const Libraries = () => {
  ...
  const [currentTab, setCurrentTab] = useLocalStorage('HRIS_Competencies_Libraries_tab', 'Competencies')
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <PageTitle
        pageTitle="Libraries"
        description="Manage the reference tables for competency gap analysis here."
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          {currentTab === 'Competencies' && <Competencies />}
          {currentTab === 'Indicators' && <Indicators />}
        </div>
      </div>
    </div>
  )
