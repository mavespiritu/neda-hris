...
const CurrentDesignation = () => {
    ...
    const emp_id = selectedStaff?.value
    const item_no = selectedStaff?.designation?.item_no
    const position = selectedStaff?.designation?.position
  ...
  return (
    <div className="flex flex-col flex-grow gap-4">
      <div>
          <h3 className="font-bold text-lg">Current Designation</h3>
          <p className="text-muted-foreground text-sm">Update your current designation's required competencies and indicators here.</p>
      </div>
...
export default CurrentDesignation