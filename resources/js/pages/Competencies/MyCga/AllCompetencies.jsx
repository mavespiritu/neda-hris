...
const AllCompetencies = () => {
  ...
  const {value: emp_id, item_no} = selectedStaff
  ...
  return (
    <div className="flex flex-col flex-grow gap-4">
      <div>
          <h3 className="font-bold text-lg">All Competencies</h3>
          <p className="text-muted-foreground text-sm">Update every competencies in the competency dictionary</p>
      </div>
      <div className="flex flex-col border rounded-lg p-4">
        <div className="flex flex-col md:flex-row justify-between"> 
          <div>
            <h5 className="font-semibold">Competency Dictionary</h5>
          </div>
        </div>
