...
const PerformanceForm = ({ open, onClose }) => {
  ...
  useEffect(() => {
    if (open) {
      ...
      fetchPerformances({ id: selectedStaff.value })
      clearErrors()
      setFileErrorMessage("")
    } else {
      reset()
    ...
    setData(prev => {
        ...
        if (selectedEvidence && selectedEvidenceData.data) {
            updatedData = {
                ...
                ipcr_id: selectedEvidenceData.data.ipcr_id ?? null,
    ...
    <Dialog open={open} onOpenChange={onClose}>
        <DialogContent>
          ...
          <DialogHeader>
              ...
              Select from your performance rating and give context for this indicator:
              <br/> 
