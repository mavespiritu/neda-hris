...
const AwardForm = ({ open, onClose }) => {
  ...
  useEffect(() => {
    if (open) {
      ...
      fetchAwards({ id: selectedStaff.value })
      clearErrors()
      setFileErrorMessage("")
    } else {
      reset()
    ...
    setData(prev => {
        ...
        if (selectedEvidence && selectedEvidenceData.data) {
            updatedData = {
                ...
                award_id: selectedEvidenceData.data.description ?? null,
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
        <DialogContent>
          {(awards.isLoading || selectedEvidenceData.isLoading) && (
