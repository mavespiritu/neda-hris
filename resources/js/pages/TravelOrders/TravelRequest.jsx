...
import TrackingTimelineCard from "@/components/TrackingTimelineCard"
    ...
    <div className="min-w-0 h-full flex flex-col">
      <div className="flex-1 min-h-0">
        ...
        <div className="flex flex-col xl:flex-row gap-6 items-start">
          ...
          <div className="w-full xl:w-[30rem] xl:shrink-0">
            <TrackingTimelineCard
              workflow={travelOrder.workflow}
              title="Travel Request Tracking"
              description="Track the progress of this travel request"
            />
          </div>
        </div>
      </div>
