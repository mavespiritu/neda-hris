...
const AttachEligibilityForm = ({ open, onClose, jobId, applicantId, requirement }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="flex flex-col text-sm font-medium border rounded-lg px-4 py-2">
              <span>{requirement?.subReq?.eligibility} ({requirement?.subReq?.rating})</span>
              <span>{formatDate(requirement?.subReq?.exam_date)}</span>
            </p>
          </div>
...
export default AttachEligibilityForm
