...
import AttachWorkExperienceForm from "./AttachWorkExperienceForm"
import { usePage } from '@inertiajs/react'
import { router } from "@inertiajs/react"
import { useToast } from "@/hooks/use-toast"

const WorkExperienceFiles = ({ req, onRefresh, applicant, vacancy }) => {
    ...
    const deleteAttachment = (fileId, requirementId) => {
        ...
        router.delete(route("applications.requirements.destroy", { vacancyId: vacancy.value, requirementId: requirementId, id: fileId}), {
            preserveScroll: true,
            onSuccess: () => {
            toast({
                title: "Success!",
