...
const EducationFiles = ({ req, onRefresh, applicant, vacancy }) => {
  ...
  const deleteAttachment = (fileId, requirementId) => {
    ...
    router.delete(
      route("applications.requirements.destroy", {
              ...
              <TableBody>
                {req.subItems?.map((sub, i) => (
                  <TableRow key={i}>
                    ...
                    <TableCell>{sub.year_graduated}</TableCell>
                          ...
                          {sub.files.map((file, fIndex) => (
                            ...
                            >
                              ...
                              {file.source === "new" ? (
                                ...
                                <button className="invisible" title="Remove">
                                  <Trash2 className="h-4 w-4 text-red-600" />
                                </button>
                              )}
                            </div>
