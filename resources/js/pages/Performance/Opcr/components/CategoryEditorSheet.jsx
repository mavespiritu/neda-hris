...
export default function CategoryEditorSheet({ open, onOpenChange, category, categoryDraft, setCategoryDraft, onSave }) {
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full overflow-y-auto sm:max-w-md">
        <SheetHeader className="text-left">
          <SheetTitle className="text-base">Edit Category</SheetTitle>
          <SheetDescription>Set the local weight and amount for this category row.</SheetDescription>
        </SheetHeader>
