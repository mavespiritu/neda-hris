  ...
  return (
    <div className="relative">
      ...
      <div className={`${formLoading ? "pointer-events-none blur-[1.5px] opacity-70" : ""} grid gap-4 transition`}>
        <div>
          <Label htmlFor="seminar_title">Title of Learning and Development Interventions / Training Programs (Write in full)</Label>
          <TextInput
            id="seminar_title"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div>
            <Label htmlFor="conducted_by">Conducted/Sponsored by</Label>
            <TextInput
              id="conducted_by"
