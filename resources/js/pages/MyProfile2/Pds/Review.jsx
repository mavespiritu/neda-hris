...
const Review = ({
  ...
  const {
    personalInformation = {},
    familyBackground = _review.familyBackground,
    educationalBackground = _review.educationalBackground,
    civilServiceEligibility = [],
    workExperience = [],
    voluntaryWork = [],
    learningAndDevelopment = [],
    otherInformation = _review.otherInformation,
  } = reviewData
    ...
    <Card>
      <CardHeader>
        <CardTitle className="font-semibold text-lg flex items-center">
          <Save className="mr-2 h-4 w-4" /> Profile
        </CardTitle>
      </CardHeader>
                  ...
                  <div className="space-y-6">
                    <section className="space-y-3">
                      <div className="grid grid-cols-2 gap-y-2">
                        ...
                        <div className="text-sm text-muted-foreground">PhilSys No.:</div>
                  ...
                  <div className="space-y-6">
                    <section className="space-y-3">
                      <div className="grid grid-cols-2 gap-y-2">
                        ...
                        <div className="text-sm font-medium">
                          {personalInformation.citizenship} {personalInformation.citizenship_by}
                        </div>
                    ...
                    <section className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-y-2">
                        ...
                        <div className="text-sm font-medium">{residentialProvinceName || residentialDistrictName}</div>
                            ...
                            <TableCell>
                              {question.answer ? (
                                <div className="flex flex-col gap-2">
                                  <Badge className="w-fit self-start">
                                    {capitalizeFirstLetter(question.answer)}
                                  </Badge>
                                  <div>
                                    {question.question_details}:
                                    {question.answer === "yes" && (
                                      <span className="underline ml-1">{question.details}</span>
                                    )}
                                  </div>
                                </div>
                              ) : ""}
                            ...
                            <TableRow key={`subquestion-${index}-${subIndex}`}>
                              ...
                              <TableCell>
                                {subQuestion.answer ? (
                                  <div className="flex flex-col gap-2">
                                    <Badge className="w-fit self-start">
                                      {capitalizeFirstLetter(subQuestion.answer)}
                                    </Badge>
                                    <div>
                                      {subQuestion.question_details}:
                                      {subQuestion.answer === "yes" && (
                                        <span className="underline ml-1">{subQuestion.details}</span>
                                      )}
                                    </div>
                                  </div>
                                ) : ""}
