...
<head>
    ...
    <title>RAA Disapproval</title>
</head>
<body style="margin: 0; padding: 24px; font-family: Arial, sans-serif; color: #111827; line-height: 1.5;">
    <h2 style="margin-top: 0;">RAA Disapproval</h2>

    <p>You are receiving this email because {{ $senderName }} has disapproved your submitted RAA.</p>
