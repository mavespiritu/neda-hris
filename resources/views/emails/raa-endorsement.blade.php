...
<head>
    ...
    <title>RAA Endorsement</title>
</head>
<body style="margin: 0; padding: 24px; font-family: Arial, sans-serif; color: #111827; line-height: 1.5;">
    <h2 style="margin-top: 0;">RAA Endorsement</h2>

    <p>
        You are receiving this email because {{ $senderName }} is requesting you to approve the submitted RAA of {{ $staffName }}.
    </p>
