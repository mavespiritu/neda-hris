...
You are receiving this email because **{{ $sender->fname }} {{ $sender->lname }}** is requesting you to review {{ $sender->gender == 'Male' ? 'his' : 'her' }} submitted CBJD for the vacant position {{ $position }}.
