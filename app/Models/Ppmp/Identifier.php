...
class Identifier extends Model
{
    ...
    protected $table = 'ppmp_identifier';
    public $timestamps = false;

    protected $fillable = ['cost_structure_id', 'organizational_outcome_id', 'program_id', 'sub_program_id', 'code', 'title', 'description'];
    protected $appends = ['label', 'cost_structure_title', 'organizational_outcome_title', 'program_title', 'sub_program_title'];
    ...
    public function getSubProgramTitleAttribute(): string
    {
        return $this->subProgram?->label ?? '';
    }

    public function paps(): HasMany
    {
        return $this->hasMany(Pap::class, 'identifier_id');
    }
}