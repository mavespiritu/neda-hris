...
class NotifyStaffOfRtoApproval extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        try {
            $mail = (new MailMessage)
                    ->subject('(DEPDev RO1 HRIS) Your RTO for flexiplace arrangement on '.$rtoDate.' has been approved')
                    ->markdown('emails.rto-approval', [
