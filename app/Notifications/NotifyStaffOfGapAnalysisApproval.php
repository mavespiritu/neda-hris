...
class NotifyStaffOfGapAnalysisApproval extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        try {
            return (new MailMessage)
                    ->subject('(DEPDev RO1 HRIS) Your Competency Gap Analysis (CGA) Submission dated '.$dateCreated.' has been approved!')
                    ->line('You are receiving this email because '.$name.' has approved your CGA on '.$dateApproved)
