...
class NotifyArdOfRtoEndorsement extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        try {
            $mail = (new MailMessage)
                    ->subject('(DEPDev RO1 HRIS) Endorsement of RTO for flexiplace arrangement of '.$staffName.' on '.$rtoDate)
                    ->markdown('emails.rto-endorsement', [
