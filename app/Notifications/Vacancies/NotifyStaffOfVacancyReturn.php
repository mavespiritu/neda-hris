...
class NotifyStaffOfVacancyReturn extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        try {
            $mail = (new MailMessage)
                    ->subject('(DEPDev RO1 HRIS) Your submitted CBJD for '.$position.' vacant position needs revision')
                    ->markdown('emails.vacancies.return', [
