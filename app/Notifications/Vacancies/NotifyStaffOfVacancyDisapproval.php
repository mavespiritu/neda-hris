...
class NotifyStaffOfVacancyDisapproval extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        try {
            $mail = (new MailMessage)
                    ->subject('(DEPDev RO1 HRIS) Your submitted CBJD for '.$position.' vacant position has been disapproved')
                    ->markdown('emails.vacancies.disapprove', [
