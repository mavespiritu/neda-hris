...
class CompetenciesForReviewApproved extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        try {
            return (new MailMessage)
                    ->subject('Your CGA submitted on '.$dateCreated.' has been approved!')
                    ->line('You are receiving this email because '.$name.' already approved your CGA on '.$dateApproved)
