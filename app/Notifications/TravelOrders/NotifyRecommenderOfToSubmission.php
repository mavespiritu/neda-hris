...
class NotifyRecommenderOfToSubmission extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        try {
            $mail = (new MailMessage)
                    ->subject('(DEPDev RO1 HRIS) Endorsement of Travel Order No.'.$travelOrder->reference_no)
                    ->markdown('emails.travel-orders.submit', [
                        'order' => $order,
