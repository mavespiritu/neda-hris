...
use App\Services\Applicants\CivilServiceEligibilityFormBuilder;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;
use Lorisleiva\Actions\ActionRequest;
use Lorisleiva\Actions\Concerns\AsAction;

class ShowCivilServiceEligibility
{
    use AsAction;
    ...
    public function asController(ActionRequest $request, ?int $applicantId = null)
    {
        try {
            ...
            Log::error('Failed to fetch applicant civil service eligibility: ' . $e->getMessage());
