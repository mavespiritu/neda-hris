...
use App\Services\Applicants\VoluntaryWorkRecordFormBuilder;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;
use Lorisleiva\Actions\ActionRequest;
use Lorisleiva\Actions\Concerns\AsAction;

class EditVoluntaryWork
{
    use AsAction;

    public function __construct(protected VoluntaryWorkRecordFormBuilder $builder)
    {
    }
    ...
    public function asController(ActionRequest $request, int $applicantId, int $id)
    {
        try {
            ...
            Log::error('Failed to fetch applicant voluntary work record: ' . $e->getMessage());
