...
class StoreCivilServiceEligibilitySection
{
    ...
    public function asController(ActionRequest $request)
    {
        try {
            ...
            $this->stepUpdater->markComplete($conn, (int) $applicantId, 'civilServiceEligibility');
            ...
            Log::error('Failed to save civil service eligibility section: ' . $e->getMessage());

            return response()->json([
                'status' => 'error',
                'title' => 'Uh oh! Something went wrong.',
                'message' => 'An error occurred while saving civil service eligibility.',
            ], 500);
        }
    }
}
