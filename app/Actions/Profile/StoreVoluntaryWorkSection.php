...
class StoreVoluntaryWorkSection
{
    ...
    public function asController(ActionRequest $request)
    {
        try {
            ...
            $this->stepUpdater->markComplete($conn, (int) $applicantId, 'voluntaryWork');
            ...
            Log::error('Failed to save voluntary work section: ' . $e->getMessage());

            return response()->json([
                'status' => 'error',
                'title' => 'Uh oh! Something went wrong.',
                'message' => 'An error occurred while saving voluntary work.',
            ], 500);
        }
    }
}
