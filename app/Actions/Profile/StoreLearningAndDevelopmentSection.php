...
class StoreLearningAndDevelopmentSection
{
    ...
    public function asController(ActionRequest $request)
    {
        try {
            ...
            $this->stepUpdater->markComplete($conn, (int) $applicantId, 'learningAndDevelopment');
            ...
            Log::error('Failed to save learning and development section: ' . $e->getMessage());

            return response()->json([
                'status' => 'error',
                'title' => 'Uh oh! Something went wrong.',
                'message' => 'An error occurred while saving learning and development.',
            ], 500);
        }
    }
}
