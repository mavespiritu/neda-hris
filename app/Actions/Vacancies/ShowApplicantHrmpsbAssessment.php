...
class ShowApplicantHrmpsbAssessment
{
    use AsAction;
    ...
    public function authorize(Request $request): bool
    {
        return $request->user() !== null
            && $request->user()->can('HRIS_recruitment.vacancies.assessment.hrmpsb.view');
    }
    ...
    public function asController(int $vacancy, int $application)
    {
        ...
        return Inertia::render('Vacancies/Assessment/ApplicantAssessment', [
            ...
            'assessmentStage' => 'hrmpsb',
            'existingAssessment' => $this->formatAssessment($hrmpsbAssessment),
            'initialAssessment' => $this->formatAssessment($secretariatAssessment),
            'backUrl' => route('vacancies.show', ['id' => $vacancy]) . '?tab=Assessment',
            'previousStageUrl' => route('vacancies.applicants.secretariat-assessment', [
                'vacancy' => $vacancy,
