...
use App\Actions\Applicants\ShowApplicantPds;
use App\Actions\Applicants\ShowApplicantPdsSection;
use App\Actions\Applicants\StoreApplicant;
...
use App\Actions\Applicants\UpdateApplicant;
...
Route::middleware(['web', 'auth.any', 'verified'])->group(function () {
    ...
    Route::post('/applicants', StoreApplicant::class)->name('applicants.store');
    Route::get('/applicants/{id}/edit', EditApplicant::class)->name('applicants.edit');
    Route::put('/applicants/{id}', UpdateApplicant::class)->name('applicants.update');
    ...
    Route::get('/applicants-pds', ShowApplicantPds::class)->name('applicants.pds');
    Route::get('/applicants-pds/{section}', ShowApplicantPdsSection::class)->name('applicants.pds.section');
